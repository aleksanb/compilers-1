...
// Helper for setting the value of a bool node
static void SetBool(node_t* node, bool boolean)
{
    node->bool_const = boolean;
...
{
       0,   146,   146,   147,   149,   153,   154,   156,   157,   159,
     160,   162,   163,   165,   166,   168,   169,   171,   172,   174,
     176,   177,   179,   180,   181,   182,   183,   184,   185,   187,
     189,   191,   192,   194,   196,   198,   200,   201,   202,   203,
...
static const char *const yytname[] =
{
  ...
  "call", "lvalue", "constant", "type", "variable", YY_NULL
};
#endif
